...
const userValidator = [
    ...
    body("title", "A title value is required").trim().isLength({ min: 3, max: 25}).escape(),
    body("description", "A valid description is required").trim().isLength({ min: 15, max: 400}).escape(),
